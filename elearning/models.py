...
<<<<<<< HEAD
    ...
    KM_Day = models.IntegerField(default=0)
    KM_Training = models.IntegerField(default=0)
    KM_Meeting = models.IntegerField(default=0)
    KM_DDoc = models.IntegerField(default=0)
    KM_Leaflets = models.IntegerField(default=0)
    KM_email = models.IntegerField(default=0)
    KM_Vdo = models.IntegerField(default=0)
    KM_Social = models.IntegerField(default=0)
